...
export const CONTENUS: readonly Contenu[] = [
  {
    ...
    chapeau:
      'La boxe anglaise se pratique aux poings, avec des gants, encadré. Aucun niveau n’est demandé pour commencer. Depuis L’Union, c’est avenue des États-Unis, dans un espace boxe de 400 m² équipé de deux rings de compétition.',
    ...
    blocs: [
      ...
      },
      {
        ...
        texte:
          'L’opposition arrive plus tard, et seulement si tu la veux. Un débutant travaille au sac, à la corde, aux pattes d’ours avec un coach, et sur le déplacement à vide. Beaucoup s’entraînent des mois sans jamais faire d’opposition.',
      },
      {
        titre: 'Deux rings de compétition',
        texte:
          'L’espace boxe fait 400 m², avec deux rings et du tapis d’entraînement autour. Deux rings, ça veut dire qu’on n’attend pas son tour : le cours avance, et le groupe compétiteurs amateurs peut travailler en même temps que les autres.',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        texte:
          'Un créneau publié pour les compétiteurs amateurs, qui préparent les combats. On n’y va que si on le décide : ce n’est jamais un passage obligé.',
      },
    ],
  },
  {
    id: 'mma',
    h1: 'Grappling et travail au sol à proximité de L’Union',
    chapeau:
      'Le travail au sol, c’est le contrôle, les projections et les soumissions — sans aucune frappe. Depuis L’Union, il se pratique avenue des États-Unis, sur 400 m² de tatamis, avec une cage surélevée officielle et des panneaux de séparation pour travailler le cage control.',
    ...
    faq: [
      {
        titre: 'Où est la salle de grappling la plus proche de L’Union ?',
        texte:
      ...
      },
      {
        ...
        texte:
          'Oui. Un débutant apprend à chuter, à se relever, à tenir une position. Aucun coup n’est porté, et l’intensité se règle. C’est le cours le plus simple à essayer quand on n’a jamais fait de sport de combat.',
      },
      {
  ...
  {
    id: 'kick-boxing',
    h1: 'Boxe pieds-poings et full contact à proximité de L’Union',
    chapeau:
    ...
    blocs: [
      ...
      },
      {
        ...
        texte:
          'C’est un règlement pieds-poings où les coups restent au-dessus de la ceinture : pas de low kick. Le club l’a ajouté avec l’ouverture de cette salle. À l’entraînement, la différence tient à quelques consignes ; au sac et à la technique, le travail est le même.',
      },
      {
  ...
  },
  {
    ...
    blocs: [
      ...
      },
      {
        ...
        texte:
          'En voiture, le périphérique et la sortie 33b « Lalande » : c’est direct depuis L’Union. Deux allers-retours par semaine, c’est tenable une année entière.',
      },
    ],
    seance: [
    ...
    blocs: [
      {
        ...
        texte:
          'Le Boxing Fitness reprend tout ce que fait un boxeur — la corde, les déplacements, le sac, les combinaisons, le gainage — sauf la partie où quelqu’un te rend les coups. Avec seize sacs, personne n’attend son tour.',
      },
      {
        titre: 'Boxing Lady, entre femmes',
        texte:
          'Un créneau publié sous ce nom, pensé pour un groupe de femmes. Le contenu n’est pas allégé : c’est le même travail technique, dans un groupe où personne n’est la seule de son genre.',
      },
      {
    ...
    faq: [
      {
        ...
        texte:
          'Le Boxing Fitness, le Boxing Lady et le cross-training se pratiquent sans opposition, du début à la fin. Tu peux pratiquer des années sans jamais faire face à quelqu’un.',
      },
      {
